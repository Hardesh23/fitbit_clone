...
(function () {
  ...
  var rc = function (a) {
    ...
    document.querySelector('.m45old.bydbje.Mm3pVd')?.addEventListener('click', () => {
      const scrollContainer = document.querySelector('.TT2Lye');
...
function showProductDetails(productName, initialImage, finalImage, breed) {
  const productDetails = document.getElementById("productDetails");
  const productImage = document.getElementById("productImage");

  productDetails.style.display = "block";
  productImage.src = initialImage;
  productImage.isInitial = true;

  document.getElementById("productName").innerText = productName;
  document.getElementById("productDescription").innerText = `
      The Pet Fitness Tracker is designed to help you keep your pet healthy, active, and motivated. 
      It tracks your dog's daily activities, including steps, distance, and calories burned. 
      With heart rate monitoring and sleep tracking, it ensures that your dog gets the right amount of exercise and rest to stay fit.

      The tracker is customizable to fit your pet's specific breed and health needs. 
      Set personalized goals for your pet, and receive real-time updates on their progress. 
      The tracker is perfect for dogs of all sizes and is built to be durable and water-resistant, making it suitable for both indoor and outdoor activities.
  `;

  const buyUrl = `/buy/${productName.toLowerCase().replace(/ /g, '-')}`;
